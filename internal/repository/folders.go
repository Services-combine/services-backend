...
//func (s *FoldersRepo) GetSettings(ctx context.Context) (settings.Settings, error) {
//	var settings settings.Settings
//
//	err := s.db.Database().Collection(settingsCollection).FindOne(ctx, bson.M{"service": ServiceInviting}).Decode(&settings)
//	return settings, err
//}
